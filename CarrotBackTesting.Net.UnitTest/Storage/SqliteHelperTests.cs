...
namespace CarrotBacktesting.Net.Storage.Tests
{
    ...
    public class SqliteHelperTests
    {
        ...
        public void QueryAsDataTableTest()
        {
            ...
            Assert.IsTrue(dt.Rows.Count == 263);
        }
        ...
        public void GetTableTest()
        {
            ...
            var dt3 = sqliteHelper.GetTable("sz.000400",
                new string[] { "[index]", "交易日期", "收盘价" },
                ("交易日期", "2021-01-01", "2021-03-31", FilterCondition.BigEqualAndSmallEqual));


            SqliteHelper sqliteHelper2 = new();
            sqliteHelper2.Open(dataDir,
            ...
            Assert.IsTrue(dt1.Count() == 263);
            Assert.IsTrue(dt2.Count() == 263 && dt2.First().Count == 3);
            Assert.IsTrue(dt3.Count() == 58);
