...
if __name__ == '__main__':
    ...
    print(
        'db_ashare_csv_dir:\t\t\t'
        + db_ashare_csv_dir + '\t\t\t'
        + ('Exist' if os.path.exists(db_ashare_csv_dir) else 'Not Exist'))

    # 下载股票信息
    stock_list = baostock_stock_basic_download(db_ashare_csv_dir)
    ...
    # 下载k线数据
    baostock_klines_download(test_stock_list, db_ashare_csv_dir, max_workers=32)
