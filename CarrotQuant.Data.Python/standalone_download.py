...
if __name__ == '__main__':
    ...
    # my_class.download_ashare(start_time=start_time, end_time=end_time, frequency='5m', adjust='post')
    # my_class.download_ashare(start_time=start_time, end_time=end_time, frequency='5m', adjust='none')
