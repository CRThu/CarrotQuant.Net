...
if __name__ == '__main__':
    ...
    my_class.download_ashare(start_time='1990-01-01', end_time='now', frequency='5m', adjust='post')
    # my_class.download_ashare(start_time='1990-01-01', end_time='now', frequency='5m', adjust='none')
